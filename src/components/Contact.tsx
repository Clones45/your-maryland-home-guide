      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 gap-16 max-w-5xl mx-auto">
          <div className="space-y-8">
            ...
            {[
              { icon: Phone, label: "(443) 922-8458", href: "tel:+14439228458" },
              { icon: Mail, label: "gayanegevorgyan@boblucidoteam.com", href: "mailto:gayanegevorgyan@boblucidoteam.com" },
              { icon: MapPin, label: "Ellicott City, Maryland", href: "#" },
